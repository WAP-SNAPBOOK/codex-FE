  ...
  return (
    <div className="owner-container">
      <div className="owner-title-bar">
        ...
        <div className="owner-title-spacer" aria-hidden="true" />
      </div>
...
function ReservationCard({ res }) {
  ...
  const [confirmedDurationMinutes, setConfirmedDurationMinutes] = useState(res.durationMinutes);
      ...
      confirmReservation(
        ...
        },
        {
          onSuccess: () => {
            ...
            setConfirmedDurationMinutes(totalMinutes);
            setMode(null);
            setMessage('');
          },
        }
  ...
  const durationText = formatDurationMinutes(confirmedDurationMinutes);
    ...
    <div className="card">
        ...
        <div className="confirm-section">
          ...
          <div className="time-adjust-box">
            ...
            <div className="time-display">
              ...
              <div className="sub-time">{formatDurationMinutes(totalMinutes)}</div>
            </div>
      ...
      {status === '예약 확정' && (
        <div className="final-box">
          {durationText ? (
            <>
              <strong className="final-title">소요 시간</strong>
              <div className="final-text">{durationText}</div>
            </>
          ) : null}
